                                        ...
                                        <div class="section text-center">
                                            ...
                                            <form action="verify_pro.php" method="POST">
                                                ...
                                                <div class="form-group mt-2">
                                                    <input type="password" name="pswd" class="form-style" placeholder="Password">
                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <form action="create_pro.php" method="POST">
                                                <div class="form-group">
                                                    <input type="text" name="name_com" class="form-style" placeholder="Full Name">
                                                    <i class="input-icon uil uil-user"></i>
                                                </div>
                                                <div class="form-group mt-2">
                                                    <input type="tel" name="phone" class="form-style" placeholder="Phone Number">
